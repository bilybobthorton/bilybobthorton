...
pub static LOLBAS_DB: Lazy<HashMap<&'static str, LolbasEntry>> = Lazy::new(|| {
    let entries = vec![
        LolbasEntry {
            ...
            mitre: "T1105,T1140",
            suspicious_args: &["-urlcache", "-decode", "-encode", "-ping", "http://", "https://", "ftp://"],
        },
        LolbasEntry {
            name: "regsvr32.exe",
            description: "Register DLL — abused to run remote scriptlets (Squiblydoo)",
            mitre: "T1218.010",
            suspicious_args: &["/s", "/u", "/n", "/i:", "http://", "https://", ".sct", "scrobj"],
        },
        LolbasEntry {
            name: "mshta.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1218.011",
            suspicious_args: &["javascript:", "http://", "shell32.dll,ShellExec", "url.dll,FileProtocolHandler", ",#"],
        },
        LolbasEntry {
            name: "msiexec.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1059.001",
            suspicious_args: &[
                "-enc", "-encoded", "-nop", "-noprofile", "-w hidden", "-windowstyle hidden",
                "-exec bypass", "-executionpolicy bypass", "iex", "invoke-expression",
                "downloadstring", "downloadfile", "webclient", "frombase64",
                "bypass", "-noninteractive", "hidden",
            ],
        },
        LolbasEntry {
            name: "pwsh.exe",
            ...
            mitre: "T1059.001",
            suspicious_args: &[
                "-enc", "-encoded", "-nop", "-noprofile", "-w hidden",
                "-exec bypass", "iex", "invoke-expression", "downloadstring",
            ],
        },
        LolbasEntry {
            name: "cmd.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1197",
            suspicious_args: &["/transfer", "/addfile", "/setnotifycmdline", "http://", "https://"],
        },
        LolbasEntry {
            name: "wmic.exe",
            description: "WMI command-line — process creation, lateral movement",
            mitre: "T1047",
            suspicious_args: &["process call create", "shadowcopy delete", "/node:", "os get", "startup"],
        },
        LolbasEntry {
            name: "msbuild.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1053.005",
            suspicious_args: &["/create", "/tr", "/sc", "/ru", "system", "onlogon", "onstart"],
        },
        LolbasEntry {
            name: "at.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1090",
            suspicious_args: &["portproxy", "add portproxy", "interface portproxy", "firewall add"],
        },
        LolbasEntry {
            name: "reg.exe",
        ...
        LolbasEntry {
            ...
            mitre: "T1059.002",
            suspicious_args: &["-e", "do shell script", "administrator privileges", "with administrator"],
        },
        LolbasEntry {
            name: "curl",
        ...
        LolbasEntry {
            ...
            mitre: "T1059.006",
            suspicious_args: &["-c", "exec(", "import socket", "import subprocess", "base64"],
        },
        LolbasEntry {
            name: "python3",
